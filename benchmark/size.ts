...
console.log(
  "Simple object JSON size:",
  new TextEncoder().encode(jsonStringSimpleObject).length,
);
...
console.log(
  "Complex object JSON size:",
  new TextEncoder().encode(jsonStringComplexObject).length,
);
...
console.log(
  "Big object JSON size:",
  new TextEncoder().encode(jsonStringBigObject).length,
);
